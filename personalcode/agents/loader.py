...
PROJECT_AGENTS_DIR = ".personalcode/agents"
USER_AGENTS_DIR = "~/.personalcode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("personalcode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from personalcode.agents.parser import parse_frontmatter, _validate_agent_meta
