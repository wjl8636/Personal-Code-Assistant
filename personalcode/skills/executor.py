...
from personalcode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from personalcode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from personalcode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
