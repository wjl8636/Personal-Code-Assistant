...
from personalcode.mcp.loading_strategy import NATIVE_TOOL_SEARCH_BETA
from personalcode.conversation_pairing import ensure_tool_pairing
from personalcode.serialization import (
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .personalcode/config.yaml or via ANTHROPIC_API_KEY env var."
            )
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .personalcode/config.yaml or via OPENAI_API_KEY env var."
            )
