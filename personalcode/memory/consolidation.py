...
from personalcode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from personalcode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".personalcode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".personalcode", "memory")
    ...
    async def _do_consolidation(
        ...
        transcript_dir = os.path.join(self._work_dir, ".personalcode", "sessions")
        ...
        checker = PermissionChecker(
            ...
            rule_engine=RuleEngine(
                ...
                project_rules_path=Path(self._work_dir) / ".personalcode" / "permissions.yaml",
                local_rules_path=Path(self._work_dir) / ".personalcode" / "permissions.local.yaml",
            ),
