...
让用户在浏览器中与 PersonalCode Agent 交互。
"""
...
from personalcode.commands import CommandContext, CommandRegistry, CommandType
from personalcode.commands.handlers import register_all_commands
from personalcode.commands.parser import parse_command
from personalcode.config import MCPServerConfig, ProviderConfig
from personalcode.conversation import ConversationManager
from personalcode.hooks import HookEngine
from personalcode.mcp import MCPManager
from personalcode.mcp.tool_wrapper import mcp_tool_name_prefix
from personalcode.memory import MemoryManager, load_instructions
from personalcode.memory.session import Session, SessionManager
...
from personalcode.web_content import INDEX_HTML
