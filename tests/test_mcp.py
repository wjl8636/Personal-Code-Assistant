...
from personalcode.config import (
    AppConfig,
    ConfigError,
    MCPServerConfig,
    build_child_env,
...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from personalcode.mcp.tool_wrapper import MCPToolWrapper
        from personalcode.mcp.client import MCPClient
...
class TestExtractText:
    def test_text_content(self) -> None:
        from mcp import types as mcp_types
        from personalcode.mcp.tool_wrapper import _extract_text
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from personalcode.mcp.manager import MCPManager
        ...
        with patch("personalcode.mcp.manager.MCPClient") as MockClient:
