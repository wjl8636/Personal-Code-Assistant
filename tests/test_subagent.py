...
from personalcode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from personalcode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from personalcode.agents.trace import TraceManager, TraceNode
from personalcode.agents.task_manager import BackgroundTask, TaskManager
from personalcode.agents.notification import format_task_notification, inject_task_notifications
from personalcode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".personalcode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from personalcode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from personalcode.tools.agent_tool import AgentToolParams
